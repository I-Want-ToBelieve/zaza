...
(import_specifier
  ((identifier) @variable.imported.specifier))

(import_clause
  ((identifier) @constructor @constructor.imported
   (#lua-match? @constructor "^[A-Z]")))
...
;----------
(namespace_import
  (identifier) @namespace @namespace.imported)
(namespace_export
  (identifier) @namespace @namespace.exported)
